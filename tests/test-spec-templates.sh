...
SKILL="$ROOT/SKILL.md"
SPEC="$ROOT/references/spec_governance.md"
DEV="$ROOT/references/dev_spec_template.md"
ALGO="$ROOT/references/algo_spec_template.md"
TRADEOFF="$ROOT/references/tradeoff_template.md"
MATRIX="$ROOT/references/matrix_template.md"
failures=0
