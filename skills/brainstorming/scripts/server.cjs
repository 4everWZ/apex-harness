...
const APEX_VERSION = readApexVersion();
...
function brandMarkup() {
  const version = escapeHtmlText(APEX_VERSION);
  return '<div class="brand"><span class="brand-copy">APEX v' + version + '</span></div>';
}
