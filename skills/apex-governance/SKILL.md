...
If the repository already has a stronger convention, follow repository truth. Otherwise, use the neutral paths above; branded or tool-specific documentation subdirectories are not the default.
