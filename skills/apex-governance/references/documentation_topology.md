...
Use the neutral topology above when the repository has no stronger convention. Do not make branded or tool-specific subdirectories the default home for specs, plans, matrices, tradeoff logs, or handoff snapshots.
